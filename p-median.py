...
oh=pd.read_csv(f"/Users/doris/Desktop/FYP/OHCA_location.csv")
aa=pd.read_csv(f"/Users/doris/Desktop/FYP/candidate_site.csv")
#Reduce the scale
#oh=oh.iloc[:30,:]
#aa=aa.iloc[:50,:]
...
aa['x']=get_solve(distance_matrix,distance_matrix1)
aa=aa[aa['x']==1]
aa.to_csv(f'/Users/doris/Desktop/FYP/candidate_site_result.csv')